          ...
          if (tab.elevated) {
            return (
              <Link
                key={tab.href}
                href={tab.href}
                className="-mt-6 flex h-14 w-14 items-center justify-center rounded-xl bg-accent text-white shadow-none transition-colors duration-200 ease-out hover:bg-accent-hover"
